...
export async function OperationalReportsPage({ searchParams, audienceLabel = 'Manager', basePath = '/manager', testId, }: PageProps & { audienceLabel?: string; basePath?: string; testId?: string; }) {
